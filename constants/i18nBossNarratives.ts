...
export const BOSS_NARRATIVE_TRANSLATIONS: Record<'en' | 'zh' | 'ru', BossNarrativeMap> = {
  ...
  "zh": {
    ...
    "glukhar": {
      ...
      "description": "格鲁哈及其众多守卫极具敌意。在开阔地带与他们交战极难成功。狭窄走廊和封闭房间是更理想的选择。格鲁哈及其守卫枪法极准。他们会始终聚集行动，守卫们会跟随格鲁哈前往任何地点。"
    },
    "kaban": {
      "bio": "他曾在塔科夫经营合法小生意，但也不惮使用犯罪手段敛财。全面撤离后他留在城内，其帮派规模日益壮大。",
      "description": "魁梧体型使他能无需架枪就持续射击各种重机枪，但同时，卡班无法灵活移动，因此在战斗中，他要么固守阵地，要么在点位间缓慢移动。其人拥有大量武装护卫，其中不乏前军人，为他组织起了严密防御。该 Boss 驻扎在“塔科夫街区”的汽车修理厂区域。该区域防御森严，入口处配备固定机枪和 AGS 榴弹发射器，通道布有地雷，汽车服务中心屋顶部署有狙击手。卡班使用定制装具携带机枪弹药箱，外衣下穿着防弹装甲，在护卫中拥有绝对权威。附近的 Scav 会协助首领防御并为卡班而战。"
    },
    "killa": {
      "bio": "",
    ...
    "kollontay": {
      "bio": "他曾是内务部军官，在执法部门服役时就以品行恶劣著称，同事有时都畏惧其行径。任职期间他常使用最爱的审讯方式——橡胶警棍，以及其他非常规手段打压不合其意者。凭借强健体魄和大胆性情，在 TerraGroup 丑闻爆发后组建帮派，开始从事自己昔日本该打击的勾当——抢劫与匪帮活动。其实在冲突前他就常为当地“商人”提供保护，例如与卡班的良好关系便广为人知。",
      "description": "葛朗台护卫数量较少，偏好固守某处，偶尔巡逻领地。若自觉占据上风，可能会切换使用警棍。他活跃在 Klimov 购物中心，以及内务部塔科夫学院周边区域。"
    },
    "partisan": {
    ...
    "reshala": {
      "bio": "",
      "description": "他通常试图待在战斗后方避开玩家视线，且从不穿戴护甲。玩家 Scav 需注意：若 Scav 声望等级较低，瑞沙拉或其守卫会无端攻击你，或因你过于接近瑞沙拉而开火。其守卫有时会对低声望玩家 Scav 发出警告后再转为敌对。"
    },
    "rogue": {
      "bio": "",
    ...
    "shturman": {
      "bio": "",
      "description": "谢特曼及其追随者会在伐木场远距离与玩家交战，偏好保持距离而不擅近距离战斗。"
    },
    "tagilla": {
      "bio": "",
    ...
    "zryachiy": {
      "bio": "塔科夫最神秘人物之一。其过往几乎无人知晓，仅知受过狙击训练，遥传曾多次出入中东与非洲热点地区。早在冲突爆发前，他就成为灯塔商人的忠犬，积极参与建立灯塔商人与所有合作者之间的联系。已知与游荡者团体及在各地绘制神秘符号的兜帽人交好。小鹿沉默寡言，但共事者常能心领神会。关于其眼睛的传闻众多，有人说是先天特征，有人指认是某种增强暗视能力的眼药水导致眼球泛白的副作用。尽管外观如此，他似乎正是因卓越视力得名——这对前军用狙击手而言并不意外。",
      "description": "灯塔商人的邪教护卫。"
    }
  },
  "ru": {
    "cultist": {
